    ...
    <div class="container">
      ...
      <nav class="navbar" data-navbar>
        ...
        <ul class="navbar-list">
          ...
          <li>
            <a href="./films.php" class="navbar-link">Films</a>
          </li>

          <li>
            <a href="acteurs.php" class="navbar-link">Acteurs</a>
          </li>

          <li>
            <a href="realisateurs.php" class="navbar-link">Réalisateurs</a>
          </li>

          <li>
            <a href="evenements.php" class="navbar-link">Evènements</a>
          </li>

          <li>
            <a href="debats.php" class="navbar-link">Débat</a>
          </li>
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <h1 class="h1 hero-title">
              Film <strong>illimité</strong>, Emissions télévisées, et plus.
            </h1>
